...
from `Mpfx/DoubleRoundingCex.lean` to the `Mpfx2` substrate. The actual
...
* `F₁_g` is a `ParityFormat` (Mpfx2's parity tier), constructed with bound
  `⊤ : WithTop NonNegDyadic`.
* Precision/quantum predicates are `ℚ`-valued in Mpfx2; membership proofs
